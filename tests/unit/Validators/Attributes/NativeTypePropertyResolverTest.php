...
#[Group(' rule')]
#[CoversClass(NativeTypePropertyResolver::class)]
final class NativeTypePropertyResolverTest extends TestCase
{
    private NativeTypePropertyResolver $resolver;

    protected function setUp(): void
    {
        $this->resolver = new NativeTypePropertyResolver();
    }
